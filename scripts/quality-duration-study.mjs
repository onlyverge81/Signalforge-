...
async function main() {
  ...
  for (const sym of STOCKS) {
    ...
    const ps = { sym, roeLatest: round(fin[fin.length - 1].roe, 3), six: { HIGH: 0, MID: 0, LOW: 0 }, hit6: [], ret6: [], alpha6: [] };
  ...
  const out = {
    generatedAt: new Date().toISOString(), source: "Polygon monthly (adjusted) + Polygon financials ROE (net income ÷ equity, by filing_date)",
